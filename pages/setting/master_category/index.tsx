...
const MasterCategoryPage = () => {
	...
	const columns: TableColumnsType<DataSourceInterface> = [
		...
		{ key: "parent", dataIndex: "parent", title: "Induk" },
	...
	return <Card>
		<div className="flex flex-col">
			<div className="flex justify-between items-center mb-5">
				<h1 className="font-medium text-base mr-5 md:text-xl">Master Category</h1>
				<Space wrap>
...
const FormModal = (props: {
	...
	>
		<Form
			...
			onFinish={onFinish}
		>
			<Form.Item label="Induk Kategori" name="category_parent">
				<Select>
					<Select.Option value={0}>Pilih</Select.Option>
					<Select.Option value="pacar">Pacar</Select.Option>
				</Select>
			</Form.Item>
